...
export class Users implements OnInit {
  ...
  onAdd(): void {
    this.router.navigate(['/academy/Account/add']);
  }

  onEdit(item: UserModel): void {
    this.router.navigate(['/academy/Account/edit', item.id]);
  }

  onDetails(item: UserModel): void {
    this.router.navigate(['/academy/Account/details', item.id]);
  }

  onView(item: UserModel): void {
    this.router.navigate(['academy/Account/logs', 'WorkCenters', item.id]);
  }

   WorkCenterDetail(payment: UserModel): void {
    this.router.navigate(['/academy/Account', payment.id]);
  }
